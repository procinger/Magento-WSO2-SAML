...
LOGOUTREQUEST;
    ...
    public static function getSessionIndexes($request)
    {
        ...
        $sessionIndexNodes = OneLogin_Saml2_Utils::query($dom, '/saml2p:LogoutRequest/saml2p:SessionIndex'); // Modified to query the WSO2 response
     ...
     */
    public function isValid($retrieveParametersFromServer=alse)
    {
        $this->_error = null;
        try {
            $dom = new DOMDocument();
