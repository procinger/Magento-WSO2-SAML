...
class OneLogin_Saml2_Utils
{
    ...
    */
    ...
    public static function query($dom, $query, $context = null)
    {
        ...
        $xpath->registerNamespace('saml2p', OneLogin_Saml2_Constants::NS_SAML2P); //register WSO2 Namespace
        $xpath->registerNamespace('saml', OneLogin_Saml2_Constants::NS_SAML);
        $xpath->registerNamespace('saml2', OneLogin_Saml2_Constants::NS_SAML2); //register WSO2 Namespace
